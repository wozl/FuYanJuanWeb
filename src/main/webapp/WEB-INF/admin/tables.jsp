...
<head>
    ...
    <title>文章评阅</title>
    <meta name="description" content="后台 页面">
    ...
    <div class="am-g tpl-g">
        ...
        <div class="left-sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    <a href="<%=request.getContextPath() %>/Admin/admintables.do" class="active">
            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-comment-o page-header-heading-icon"></span>文章评阅<small></small></div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">文章评阅</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br">
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name"  value="${requestScope.Title}" disabled="disabled" placeholder="请输入标题文字">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text"  value="${requestScope.time}"  class="am-form-field tpl-form-no-bg"  disabled="disabled" placeholder="发布时间" data-am-datepicker="" readonly="">
                                            <small>发布时间为必填</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <small id="Author">${requestScope.Author}</small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label for="user-intro" class="am-u-sm-3 am-form-label">文章内容</label>
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" id="user-intro"  disabled="disabled"   placeholder="请输入文章内容">${requestScope.content}</textarea>
                                        </div>
                                    </div>
									
									<div class="am-form-group">
                                        <label for="user-intro" class="am-u-sm-3 am-form-label">评语</label>
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" id="user-intro" placeholder="请输入评语内容"></textarea>
                                        </div>
                                    </div>
